...
namespace RapidField.SolidInstruments.Example.Domain.Events.ModelState.UserRoleAssignment
{
    /// <summary>
    /// Represents information about an update to a <see cref="DomainModel" />.
    /// </summary>
    [DataContract(Name = DataContractName)]
    public sealed class DomainModelUpdatedEvent : DomainModelUpdatedEvent<DomainModel>
    {
        /// <summary>
        ...
        /// <paramref name="correlationIdentifier" /> is equal to <see cref="Guid.Empty" />.
        /// </exception>
        public DomainModelUpdatedEvent(DomainModel model, IEnumerable<String> labels, Guid correlationIdentifier)
        ...
        /// <paramref name="correlationIdentifier" /> is equal to <see cref="Guid.Empty" />.
        /// </exception>
        public DomainModelUpdatedEvent(DomainModel model, IEnumerable<String> labels, EventVerbosity verbosity, Guid correlationIdentifier)
