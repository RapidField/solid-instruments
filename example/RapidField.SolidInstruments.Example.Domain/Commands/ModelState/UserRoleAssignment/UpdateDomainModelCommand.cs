...
namespace RapidField.SolidInstruments.Example.Domain.Commands.ModelState.UserRoleAssignment
{
    ...
    public sealed class UpdateDomainModelCommand : UpdateDomainModelReportableCommand<DomainModel, ReportedEvent>
    {
        /// <summary>
        ...
        internal const String DataContractName = DataContractNameVerb + DomainModel.DataContractName + DataContractNameSuffix;
    }
}