...
namespace RapidField.SolidInstruments.Example.DatabaseModel.Repositories
{
    ...
    /// </summary>
    public sealed class NumberSeriesNumberRepository : EntityFrameworkRepository<NumberSeriesNumber, ExampleContext>
    {
        /// <summary>
        ...
        /// </exception>
        public NumberSeriesNumberRepository(ExampleContext context)
            : base(context)
        {
            return;
        }
