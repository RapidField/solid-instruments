...
{
    /// <summary>
    /// Represents an <see cref="ScalarLineSeries{TXAxis, TYAxis}" /> derivative that is used for testing.
    /// </summary>
    internal sealed class SimulatedScalarLineSeries : ScalarLineSeries<Int32, Decimal>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimulatedScalarLineSeries" /> class.
        /// </summary>
        /// <param name="data">
        ...
        /// </exception>
        public SimulatedScalarLineSeries(IDictionary<Int32, Decimal> data)
            : base(data)
        {
            return;
        }
