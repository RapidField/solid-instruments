...
{
    [TestClass]
    public class DurableMessageLockTokenTests
    {
        [TestMethod]
        ...
        private static void ShouldBeSerializable(SerializationFormat format)
        {
            ...
            var target = new DurableMessageLockToken(identifier, messageIdentifier, expirationDateTime);
            var serializer = new DynamicSerializer<DurableMessageLockToken>(format);
