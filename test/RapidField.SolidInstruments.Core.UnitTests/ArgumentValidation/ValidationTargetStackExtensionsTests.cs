...
{
    [TestClass]
    public class ValidationTargetStackExtensionsTests
    {
        [TestMethod]
        public void IsNullOrEmpty_ShouldConveyTargetArgumentParameterName()
        {
            // Arrange.
            var target = (Stack<Int32>)null;
        ...
        {
            // Arrange.
            var target = new Stack<Int32>(new Int32[1] { 3 });
