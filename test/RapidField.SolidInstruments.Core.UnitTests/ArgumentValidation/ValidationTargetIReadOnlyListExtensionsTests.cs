...
{
    [TestClass]
    public class ValidationTargetIReadOnlyListExtensionsTests
    {
        [TestMethod]
        public void IsNullOrEmpty_ShouldConveyTargetArgumentParameterName()
        {
            // Arrange.
            var target = (IReadOnlyList<Int32>)null;
        ...
        {
            // Arrange.
            var target = new List<Int32>(new Int32[1] { 3 }) as IReadOnlyList<Int32>;
        ...
        {
            // Arrange.
            var target = new List<Int32>() as IReadOnlyList<Int32>;
        ...
        public void IsNullOrEmpty_ShouldReturnTarget()
        {
            // Arrange.
            var target = new List<Int32>(new Int32[1] { 3 }) as IReadOnlyList<Int32>;
            var result = (IReadOnlyList<Int32>)null;
