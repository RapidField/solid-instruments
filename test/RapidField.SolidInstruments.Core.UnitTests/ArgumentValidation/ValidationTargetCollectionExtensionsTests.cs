...
{
    [TestClass]
    public class ValidationTargetCollectionExtensionsTests
    {
        [TestMethod]
        public void IsNullOrEmpty_ShouldConveyTargetArgumentParameterName()
        {
            // Arrange.
            var target = (Collection<Int32>)null;
        ...
        {
            // Arrange.
            var target = new Collection<Int32>(new Int32[1] { 3 });
        ...
        {
            // Arrange.
            var target = new Collection<Int32>();
        ...
        public void IsNullOrEmpty_ShouldReturnTarget()
        {
            // Arrange.
            var target = new Collection<Int32>(new Int32[1] { 3 });
            var result = (Collection<Int32>)null;
