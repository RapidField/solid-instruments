...
{
    [TestClass]
    public class ValidationTargetIReadOnlyDictionaryExtensionsTests
    {
        [TestMethod]
        public void IsNullOrEmpty_ShouldConveyTargetArgumentParameterName()
        {
            // Arrange.
            var target = (IReadOnlyDictionary<Int32, String>)null;
        ...
        {
            // Arrange.
            var target = new ReadOnlyDictionary<Int32, String>(new Dictionary<Int32, String>() { { 1, "foo" } }) as IReadOnlyDictionary<Int32, String>;
        ...
        {
            // Arrange.
            var target = new ReadOnlyDictionary<Int32, String>(new Dictionary<Int32, String>()) as IReadOnlyDictionary<Int32, String>;
        ...
        public void IsNullOrEmpty_ShouldReturnTarget()
        {
            // Arrange.
            var target = new ReadOnlyDictionary<Int32, String>(new Dictionary<Int32, String>() { { 1, "foo" } }) as IReadOnlyDictionary<Int32, String>;
            var result = (IReadOnlyDictionary<Int32, String>)null;
