...
{
    [TestClass]
    public class ValidationTargetIListExtensionsTests
    {
        [TestMethod]
        public void IsNullOrEmpty_ShouldConveyTargetArgumentParameterName()
        {
            // Arrange.
            var target = (IList<Int32>)null;
        ...
        {
            // Arrange.
            var target = new List<Int32>(new Int32[1] { 3 }) as IList<Int32>;
        ...
        {
            // Arrange.
            var target = new List<Int32>() as IList<Int32>;
