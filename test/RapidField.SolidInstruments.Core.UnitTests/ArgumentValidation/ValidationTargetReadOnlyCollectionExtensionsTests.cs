...
{
    [TestClass]
    public class ValidationTargetReadOnlyCollectionExtensionsTests
    {
        [TestMethod]
        public void IsNullOrEmpty_ShouldConveyTargetArgumentParameterName()
        {
            // Arrange.
            var target = (ReadOnlyCollection<Int32>)null;
        ...
        {
            // Arrange.
            var target = new ReadOnlyCollection<Int32>(new Int32[1] { 3 });
        ...
        {
            // Arrange.
            var target = new ReadOnlyCollection<Int32>(Array.Empty<Int32>());
        ...
        public void IsNullOrEmpty_ShouldReturnTarget()
        {
            // Arrange.
            var target = new ReadOnlyCollection<Int32>(new Int32[1] { 3 });
            var result = (ReadOnlyCollection<Int32>)null;
