...
{
    [TestClass]
    public class ValidationTargetIReadOnlyCollectionExtensionsTests
    {
        [TestMethod]
        public void IsNullOrEmpty_ShouldConveyTargetArgumentParameterName()
        {
            // Arrange.
            var target = (IReadOnlyCollection<Int32>)null;
        ...
        {
            // Arrange.
            var target = new ReadOnlyCollection<Int32>(new Int32[1] { 3 }) as IReadOnlyCollection<Int32>;
        ...
        {
            // Arrange.
            var target = new ReadOnlyCollection<Int32>(Array.Empty<Int32>()) as IReadOnlyCollection<Int32>;
        ...
        public void IsNullOrEmpty_ShouldReturnTarget()
        {
            // Arrange.
            var target = new ReadOnlyCollection<Int32>(new Int32[1] { 3 }) as IReadOnlyCollection<Int32>;
            var result = (IReadOnlyCollection<Int32>)null;
