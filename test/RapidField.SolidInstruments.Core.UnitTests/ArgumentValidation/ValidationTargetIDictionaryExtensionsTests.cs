...
{
    [TestClass]
    public class ValidationTargetIDictionaryExtensionsTests
    {
        [TestMethod]
        public void IsNullOrEmpty_ShouldConveyTargetArgumentParameterName()
        {
            // Arrange.
            var target = (IDictionary<Int32, String>)null;
        ...
        {
            // Arrange.
            var target = new Dictionary<Int32, String>() { { 1, "foo" } } as IDictionary<Int32, String>;
        ...
        {
            // Arrange.
            var target = new Dictionary<Int32, String>() as IDictionary<Int32, String>;
        ...
        public void IsNullOrEmpty_ShouldReturnTarget()
        {
            // Arrange.
            var target = new Dictionary<Int32, String>() { { 1, "foo" } } as IDictionary<Int32, String>;
            var result = (IDictionary<Int32, String>)null;
