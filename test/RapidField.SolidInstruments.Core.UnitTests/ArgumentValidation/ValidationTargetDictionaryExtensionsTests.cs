...
{
    [TestClass]
    public class ValidationTargetDictionaryExtensionsTests
    {
        [TestMethod]
        public void IsNullOrEmpty_ShouldConveyTargetArgumentParameterName()
        {
            // Arrange.
            var target = (Dictionary<Int32, String>)null;
        ...
        {
            // Arrange.
            var target = new Dictionary<Int32, String>() { { 1, "foo" } };
        ...
        {
            // Arrange.
            var target = new Dictionary<Int32, String>();
        ...
        public void IsNullOrEmpty_ShouldReturnTarget()
        {
            // Arrange.
            var target = new Dictionary<Int32, String>() { { 1, "foo" } };
            var result = (Dictionary<Int32, String>)null;
