...
{
    /// <summary>
    /// Represents an equivalent pair of a <see cref="Number" /> and its underlying <see cref="SByte" /> which is made available for
    /// testing.
    /// </summary>
    internal sealed class SByteNumericTestPair : NumericTestPair<SByte>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SByteNumericTestPair" /> class.
        /// </summary>
        /// <param name="numericValue">
        /// The primitive numeric data value defining the numeric test pair.
        /// </param>
        [DebuggerHidden]
        internal SByteNumericTestPair(SByte numericValue)
            : base(numericValue)
        {
            return;
        }
        ...
        /// <see cref="SByteNumericTestPair" /> is equal to and comparatively equivalent to its <see cref="Number" />.
        /// </summary>
        /// <param name="value">
        ...
        /// </summary>
        public static readonly IEnumerable<NumericTestPair> Cases = new SByteNumericTestPair[]
        {
            new(SByte.MinValue),
            new(-89),
            new(-13),
