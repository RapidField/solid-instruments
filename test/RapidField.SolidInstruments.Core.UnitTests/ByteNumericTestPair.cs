...
namespace RapidField.SolidInstruments.Core.UnitTests
{
    ...
    internal sealed class ByteNumericTestPair : NumericTestPair<Byte>
    {
        ...
        /// </returns>
        protected sealed override Rational ConvertValueToBigRational(Byte value) => value.ToBigRational();
        ...
        /// </returns>
        protected sealed override Boolean VerifyStateConsistency(Byte value, Number number) => number == value && number.Equals(ConvertValueToBigRational(value)) && number < value is false && number > value is false;
