...
namespace RapidField.SolidInstruments.Core.UnitTests
{
    ...
    internal sealed class Int64NumericTestPair : NumericTestPair<Int64>
    {
        ...
        /// </returns>
        protected sealed override Boolean VerifyStateConsistency(Int64 value, Number number) => number == value && number.Equals(ConvertValueToBigRational(value)) && number < value is false && number > value is false;
