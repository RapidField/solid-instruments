...
namespace RapidField.SolidInstruments.Core.UnitTests
{
    ...
    internal sealed class Int16NumericTestPair : NumericTestPair<Int16>
    {
        ...
        /// </returns>
        protected sealed override Boolean VerifyStateConsistency(Int16 value, Number number) => number == value && number.Equals(ConvertValueToBigRational(value)) && number < value is false && number > value is false;
