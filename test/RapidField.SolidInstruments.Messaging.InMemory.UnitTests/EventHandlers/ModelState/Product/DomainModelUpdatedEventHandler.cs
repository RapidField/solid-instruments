...
namespace RapidField.SolidInstruments.Messaging.InMemory.UnitTests.EventHandlers.ModelState.Product
{
    ...
    internal class DomainModelUpdatedEventHandler : DomainModelUpdatedEventHandler<DomainModel, DomainModelEvent>
    {
        ...
        {
            var existingModel = SimulatedServiceState.Products.Where(entity => entity.Identifier == model.Identifier).FirstOrDefault();
            ...
            SimulatedServiceState.Products.Remove(existingModel);
            SimulatedServiceState.Products.Add(model);
        }
    }
}