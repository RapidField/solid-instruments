...
using ReportedEvent = RapidField.SolidInstruments.Messaging.InMemory.UnitTests.Events.ModelState.CustomerOrder.DomainModelDeletedEvent;

namespace RapidField.SolidInstruments.Messaging.InMemory.UnitTests.Commands.ModelState.CustomerOrder
{
    /// <summary>
    ...
    internal sealed class DeleteDomainModelCommand : DeleteDomainModelReportableCommand<DomainModel, ReportedEvent>
    {
        ...
        private const String DataContractName = "DeleteCustomerOrderEvent";
    }
}