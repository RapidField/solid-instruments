...
namespace RapidField.SolidInstruments.InversionOfControl.Autofac.UnitTests
{
    ...
    internal sealed class SimulatedAutofacDependencyModule : AutofacDependencyModule
    {
        ...
        /// Configuration information for the application.
        /// </param>
        protected override void Configure(ContainerBuilder configurator, IConfiguration applicationConfiguration) => configurator.RegisterType<SimulatedInstrument>().AsSelf().InstancePerLifetimeScope();
    }
}