...
{
    /// <summary>
    /// Encapsulates native .NET container configuration for a service bus connection and related transport dependencies.
    /// </summary>
    public abstract class DotNetNativeTransportDependencyModule : DotNetNativeDependencyModule, ITransportDependencyModule<ServiceCollection>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DotNetNativeTransportDependencyModule" /> class.
        /// </summary>
        ...
        /// </exception>
        protected DotNetNativeTransportDependencyModule(IConfiguration applicationConfiguration, String connectionStringConfigurationKeyName)
