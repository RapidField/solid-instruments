...
namespace RapidField.SolidInstruments.Messaging.DotNetNative
{
    ...
    /// </summary>
    public class DotNetNativeMessageHandlerModule : DotNetNativeDependencyModule, IMessageHandlerModule<ServiceCollection>
    {
        /// <summary>
        ...
        /// <see langword="null" />.
        /// </exception>
        public DotNetNativeMessageHandlerModule(IConfiguration applicationConfiguration, Assembly targetAssembly)
        ...
        /// <paramref name="applicationConfiguration" /> is <see langword="null" />.
        /// </exception>
        protected DotNetNativeMessageHandlerModule(IConfiguration applicationConfiguration, Boolean registersMessageListenerTypes, Boolean registersMessageTransmitterTypes)
        ...
        /// <see langword="null" />.
        /// </exception>
        protected DotNetNativeMessageHandlerModule(IConfiguration applicationConfiguration, Boolean registersMessageListenerTypes, Boolean registersMessageTransmitterTypes, Assembly targetAssembly)
            : base(applicationConfiguration)
        {
            RegistersMessageListenerTypes = registersMessageListenerTypes;
            RegistersMessageTransmitterTypes = registersMessageTransmitterTypes;
        ...
        /// </param>
        [DebuggerHidden]
        private static void RegisterCommandMessageListenerTypes(ServiceCollection configurator, IEnumerable<Type> messageListenerTypes, IList<String> registeredTypeNames)
        {
            foreach (var messageListenerType in messageListenerTypes)
            {
                ...
                configurator.AddCommandMessageListener(commandMessageType, messageListenerType);
        ...
        /// </param>
        [DebuggerHidden]
        private static void RegisterCommandMessageTransmitterTypes(ServiceCollection configurator, IEnumerable<Type> messageTransmitterTypes, IList<String> registeredTypeNames)
        {
            foreach (var messageTransmitterType in messageTransmitterTypes)
            {
                ...
                configurator.AddCommandMessageTransmitter(commandMessageType, messageTransmitterType);
                registeredTypeNames.Add(typeName);
            }
        }
        ...
        /// </param>
        [DebuggerHidden]
        private static void RegisterCustomMessageListenerTypes(ServiceCollection configurator, IEnumerable<Type> messageListenerTypes, IList<String> registeredTypeNames)
        {
            foreach (var messageListenerType in messageListenerTypes)
            {
                var typeName = messageListenerType.FullName;
                ...
                configurator.AddMessageListener(customMessageType, messageListenerType);
                registeredTypeNames.Add(typeName);
            }
        }
        ...
        /// </param>
        [DebuggerHidden]
        private static void RegisterCustomMessageTransmitterTypes(ServiceCollection configurator, IEnumerable<Type> messageTransmitterTypes, IList<String> registeredTypeNames)
        {
            foreach (var messageTransmitterType in messageTransmitterTypes)
            {
                var typeName = messageTransmitterType.FullName;
                ...
                configurator.AddMessageTransmitter(customMessageType, messageTransmitterType);
                registeredTypeNames.Add(typeName);
            }
        }
        ...
        /// </param>
        [DebuggerHidden]
        private static void RegisterEventMessageListenerTypes(ServiceCollection configurator, IEnumerable<Type> messageListenerTypes, IList<String> registeredTypeNames)
        {
            foreach (var messageListenerType in messageListenerTypes)
            {
                var typeName = messageListenerType.FullName;
                ...
                configurator.AddEventMessageListener(eventMessageType, messageListenerType);
                registeredTypeNames.Add(typeName);
            }
        }
        ...
        /// </param>
        [DebuggerHidden]
        private static void RegisterEventMessageTransmitterTypes(ServiceCollection configurator, IEnumerable<Type> messageTransmitterTypes, IList<String> registeredTypeNames)
        {
            foreach (var messageTransmitterType in messageTransmitterTypes)
            {
                var typeName = messageTransmitterType.FullName;
                ...
                configurator.AddEventMessageTransmitter(eventMessageType, messageTransmitterType);
                registeredTypeNames.Add(typeName);
            }
        }
        ...
        /// </param>
        [DebuggerHidden]
        private static void RegisterRequestMessageListenerTypes(ServiceCollection configurator, IEnumerable<Type> messageListenerTypes, IList<String> registeredTypeNames)
        {
            foreach (var messageListenerType in messageListenerTypes)
            {
                var typeName = messageListenerType.FullName;
                ...
                configurator.AddRequestMessageListener(requestMessageType, responseMessageType, messageListenerType);
                registeredTypeNames.Add(typeName);
            }
        }
        ...
        /// </param>
        [DebuggerHidden]
        private static void RegisterRequestMessageTransmitterTypes(ServiceCollection configurator, IEnumerable<Type> messageTransmitterTypes, IList<String> registeredTypeNames)
        {
            foreach (var messageTransmitterType in messageTransmitterTypes)
            {
                var typeName = messageTransmitterType.FullName;
                ...
                configurator.AddRequestMessageTransmitter(requestMessageType, responseMessageType, messageTransmitterType);
                registeredTypeNames.Add(typeName);
            }
        }
        ...
        /// </param>
        [DebuggerHidden]
        private void RegisterMessageListenerTypes(ServiceCollection configurator)
        {
        ...
        /// </param>
        [DebuggerHidden]
        private void RegisterMessageTransmitterTypes(ServiceCollection configurator)
        {
        ...
        /// <summary>
        /// Gets a value indicating whether or not the current <see cref="DotNetNativeMessageHandlerModule" /> registers message
        /// listener types defined by <see cref="TargetAssembly" />.
        /// </summary>
        ...
        /// <summary>
        /// Represents a default value indicating whether or not the current <see cref="DotNetNativeMessageHandlerModule" />
        /// registers message listener types defined by <see cref="TargetAssembly" />.
        /// </summary>
        ...
        /// <summary>
        /// Represents a default value indicating whether or not the current <see cref="DotNetNativeMessageHandlerModule" />
        /// registers message transmitter types defined by <see cref="TargetAssembly" />.
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
