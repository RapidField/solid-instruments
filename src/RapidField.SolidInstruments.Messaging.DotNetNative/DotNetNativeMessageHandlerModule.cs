...
namespace RapidField.SolidInstruments.Messaging.DotNetNative
{
    ...
    /// </summary>
    public abstract class DotNetNativeMessageHandlerModule : DotNetNativeDependencyModule, IMessageHandlerModule<ServiceCollection>
    {
        /// <summary>
        ...
        /// <see langword="null" />.
        /// </exception>
        protected DotNetNativeMessageHandlerModule(IConfiguration applicationConfiguration, Assembly targetAssembly)
            : base(applicationConfiguration)
        {
        ...
        /// Configuration information for the application.
        /// </param>
        protected abstract void ConfigureMessageType(Type messageType, ServiceCollection configurator, IConfiguration applicationConfiguration);
