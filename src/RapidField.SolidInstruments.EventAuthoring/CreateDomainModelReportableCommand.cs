...
namespace RapidField.SolidInstruments.EventAuthoring
{
    ...
    /// </summary>
    /// <remarks>
    /// <see cref="CreateDomainModelReportableCommand{TModel, TEvent}" /> is a derivative of
    /// <see cref="CreateDomainModelCommand{TModel}" /> which is extended to support <see cref="IReportableCommand{TEvent}" />.
    /// </remarks>
    ...
    /// </typeparam>
    [DataContract]
    public class CreateDomainModelReportableCommand<TModel, TEvent> : CreateDomainModelCommand<TModel>, IDomainModelReportableCommand<TModel, TEvent>
        where TModel : class, IDomainModel
        where TEvent : DomainModelEvent<TModel>, IDomainModelCreatedEvent<TModel>, new()
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDomainModelReportableCommand{TModel, TEvent}" /> class.
        /// </summary>
        public CreateDomainModelReportableCommand()
            : base()
        {
            return;
        }
        ...
        /// </exception>
        public CreateDomainModelReportableCommand(Guid correlationIdentifier)
        ...
        /// </exception>
        public CreateDomainModelReportableCommand(TModel model)
            : base(model)
        {
            return;
        }
        ...
        /// <paramref name="correlationIdentifier" /> is equal to <see cref="Guid.Empty" />.
        /// </exception>
        public CreateDomainModelReportableCommand(TModel model, Guid correlationIdentifier)
        ...
        /// </exception>
        public CreateDomainModelReportableCommand(TModel model, IEnumerable<String> labels)
            : base(model, labels)
        {
            return;
        }
        ...
        /// <paramref name="correlationIdentifier" /> is equal to <see cref="Guid.Empty" />.
        /// </exception>
        public CreateDomainModelReportableCommand(TModel model, IEnumerable<String> labels, Guid correlationIdentifier)
        ...
        /// <see cref="CreateDomainModelReportableCommand{TModel, TEvent}" />.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Gets the type of the event that describes the current <see cref="CreateDomainModelReportableCommand{TModel, TEvent}" />.
        /// </summary>
        [IgnoreDataMember]
