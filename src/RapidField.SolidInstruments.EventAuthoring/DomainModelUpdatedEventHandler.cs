...
{
    /// <summary>
    /// Processes a single <see cref="IDomainModelUpdatedEvent{TModel}" />.
    /// </summary>
    ...
    /// </typeparam>
    public abstract class DomainModelUpdatedEventHandler<TModel, TEvent> : DomainModelEventHandler<TModel, TEvent>
        where TModel : class, IDomainModel
        where TEvent : class, IDomainModelUpdatedEvent<TModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainModelUpdatedEventHandler{TModel, TEvent}" /> class.
        /// </summary>
        /// <param name="mediator">
        ...
        /// </exception>
        protected DomainModelUpdatedEventHandler(ICommandMediator mediator)
            : base(mediator)
        {
            return;
        }
        ...
        /// <summary>
        /// Releases all resources consumed by the current <see cref="DomainModelUpdatedEventHandler{TModel, TEvent}" />.
        /// </summary>
