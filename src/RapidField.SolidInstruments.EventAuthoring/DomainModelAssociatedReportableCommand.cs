...
{
    /// <summary>
    /// Represents a command related to an object that models a domain construct.
    /// </summary>
    /// <remarks>
    /// <see cref="DomainModelAssociatedReportableCommand{TModel, TEvent}" /> is a derivative of
    /// <see cref="DomainModelAssociatedCommand{TModel}" /> which is extended to support <see cref="IReportableCommand{TEvent}" />.
    /// </remarks>
    ...
    /// </typeparam>
    [DataContract]
    public class DomainModelAssociatedReportableCommand<TModel, TEvent> : DomainModelAssociatedCommand<TModel>, IDomainModelReportableCommand<TModel, TEvent>
        where TModel : class, IDomainModel
        where TEvent : DomainModelEvent<TModel>, IDomainModelAssociatedEvent<TModel>, new()
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainModelAssociatedReportableCommand{TModel, TEvent}" /> class.
        /// </summary>
        public DomainModelAssociatedReportableCommand()
            : base()
        {
            return;
        }
        ...
        /// </exception>
        public DomainModelAssociatedReportableCommand(Guid correlationIdentifier)
        ...
        /// </exception>
        public DomainModelAssociatedReportableCommand(TModel model)
            : base(model)
        {
            return;
        }
        ...
        /// <paramref name="correlationIdentifier" /> is equal to <see cref="Guid.Empty" />.
        /// </exception>
        public DomainModelAssociatedReportableCommand(TModel model, Guid correlationIdentifier)
        ...
        /// </exception>
        public DomainModelAssociatedReportableCommand(TModel model, IEnumerable<String> labels)
            : base(model, labels)
        {
            return;
        }
        ...
        /// <paramref name="correlationIdentifier" /> is equal to <see cref="Guid.Empty" />.
        /// </exception>
        public DomainModelAssociatedReportableCommand(TModel model, IEnumerable<String> labels, Guid correlationIdentifier)
        ...
        /// <see cref="DomainModelAssociatedReportableCommand{TModel, TEvent}" />.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Gets the type of the event that describes the current
        /// <see cref="DomainModelAssociatedReportableCommand{TModel, TEvent}" />.
        /// </summary>
        [IgnoreDataMember]
