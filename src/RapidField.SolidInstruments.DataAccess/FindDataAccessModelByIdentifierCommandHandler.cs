...
{
    /// <summary>
    /// Processes a single <see cref="FindDataAccessModelByIdentifierCommand{TIdentifier, TDataAccessModel}" />.
    /// </summary>
    ...
    /// </typeparam>
    public class FindDataAccessModelByIdentifierCommandHandler<TIdentifier, TDataAccessModel, TRepository> : DataAccessModelCommandHandler<TIdentifier, TDataAccessModel, FindDataAccessModelByIdentifierCommand<TIdentifier, TDataAccessModel>, TRepository, TDataAccessModel>
        ...
        where TRepository : class, IDataAccessModelRepository<TIdentifier, TDataAccessModel>
    {
        ...
        /// <see cref="FindDataAccessModelByIdentifierCommandHandler{TIdentifier, TDataAccessModel, TRepository}" /> class.
        /// </summary>
        /// <param name="mediator">
        ...
        /// </exception>
        public FindDataAccessModelByIdentifierCommandHandler(ICommandMediator mediator, IDataAccessRepositoryFactory repositoryFactory, IDataAccessTransaction transaction)
        ...
        /// <see cref="FindDataAccessModelByIdentifierCommandHandler{TIdentifier, TDataAccessModel, TRepository}" />.
        /// </summary>
        ...
        /// </param>
        protected override TDataAccessModel Process(FindDataAccessModelByIdentifierCommand<TIdentifier, TDataAccessModel> command, ICommandMediator mediator, TRepository repository, IConcurrencyControlToken controlToken) => repository.FindByIdentifier(command.ModelIdentifier);
    }
}