...
namespace RapidField.SolidInstruments.Command
{
    ...
    /// </typeparam>
    public abstract class CreateDomainModelCommandHandler<TModel, TCommand> : DomainModelCommandHandler<TModel, TCommand>
        where TModel : class, IDomainModel
        where TCommand : class, ICreateDomainModelCommand<TModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDomainModelCommandHandler{TModel, TCommand}" /> class.
        /// </summary>
        /// <param name="mediator">
        ...
        /// </exception>
        protected CreateDomainModelCommandHandler(ICommandMediator mediator)
            : base(mediator)
        {
            return;
        }
        ...
        /// </param>
        protected abstract void CreateDomainModel(TModel model, IEnumerable<String> labels, Guid correlationIdentifier, ICommandMediator mediator, IConcurrencyControlToken controlToken);
        ...
        /// A token that represents and manages contextual thread safety.
        /// </param>
        protected sealed override void Process(TCommand command, ICommandMediator mediator, IConcurrencyControlToken controlToken) => CreateDomainModel(command.Model, command.Labels, command.CorrelationIdentifier, mediator, controlToken);
    }
}