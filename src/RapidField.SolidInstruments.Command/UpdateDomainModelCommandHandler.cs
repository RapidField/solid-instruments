...
namespace RapidField.SolidInstruments.Command
{
    ...
    /// </typeparam>
    public abstract class UpdateDomainModelCommandHandler<TModel, TCommand> : DomainModelCommandHandler<TModel, TCommand>
        where TModel : class, IDomainModel
        where TCommand : class, IUpdateDomainModelCommand<TModel>
    {
        /// <summary>
        ...
        /// </exception>
        protected UpdateDomainModelCommandHandler(ICommandMediator mediator)
            : base(mediator)
        {
            return;
        }
        ...
        /// </param>
        protected sealed override void Process(TCommand command, ICommandMediator mediator, IConcurrencyControlToken controlToken) => UpdateDomainModel(command.Model, command.Labels, command.CorrelationIdentifier, mediator, controlToken);
        ...
        /// A token that represents and manages contextual thread safety.
        /// </param>
        protected abstract void UpdateDomainModel(TModel model, IEnumerable<String> labels, Guid correlationIdentifier, ICommandMediator mediator, IConcurrencyControlToken controlToken);
    }
}