...
namespace RapidField.SolidInstruments.Messaging.EventMessages
{
        ...
        where TEvent : DomainModelDeletedEvent<TModel>, new()
    {
        ...
        /// </exception>
        protected DomainModelDeletedEventMessage(TEvent eventObject, Guid correlationIdentifier)
        ...
        /// </exception>
        protected DomainModelDeletedEventMessage(TEvent eventObject, Guid correlationIdentifier, Guid identifier)
