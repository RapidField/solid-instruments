...
{
    /// <summary>
    /// Facilitates transmission operations for RabbitMQ queues.
    /// </summary>
    public sealed class RabbitMqTransmittingFacade : MessageTransmittingFacade<IMessagingEntitySendClient, IMessagingEntityReceiveClient, PrimitiveMessage>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RabbitMqTransmittingFacade" /> class.
        /// </summary>
        ...
        /// <see langword="null" />.
        /// </exception>
        public RabbitMqTransmittingFacade(IMessagingClientFactory<IMessagingEntitySendClient, IMessagingEntityReceiveClient, PrimitiveMessage> clientFactory, IMessageAdapter<PrimitiveMessage> messageAdapter)
        ...
        /// <summary>
        /// Releases all resources consumed by the current <see cref="RabbitMqTransmittingFacade" />.
        /// </summary>
