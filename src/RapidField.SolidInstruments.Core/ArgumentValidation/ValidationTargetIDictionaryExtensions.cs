...
namespace RapidField.SolidInstruments.Core.ArgumentValidation
{
    ...
    /// <see cref="IDictionary{TKey, TValue}" /> arguments.
    /// </summary>
    public static class ValidationTargetIDictionaryExtensions
    {
        /// <summary>
        ...
        public static ValidationResult<IDictionary<TKey, TValue>> IsNullOrEmpty<TKey, TValue>(this ValidationTarget<IDictionary<TKey, TValue>> target) => target.IsNullOrEmpty(null);
        ...
        [DebuggerHidden]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValidationResult<IDictionary<TKey, TValue>> IsNullOrEmpty<TKey, TValue>(this ValidationTarget<IDictionary<TKey, TValue>> target, String targetParameterName) => target.RejectIfIsNullOrEmpty<IDictionary<TKey, TValue>, KeyValuePair<TKey, TValue>>(targetParameterName);
    }
}