...
namespace RapidField.SolidInstruments.Core.ArgumentValidation
{
    ...
    /// <see cref="IReadOnlyCollection{T}" /> arguments.
    /// </summary>
    public static class ValidationTargetIReadOnlyCollectionExtensions
    {
        /// <summary>
        ...
        public static ValidationResult<IReadOnlyCollection<T>> IsNullOrEmpty<T>(this ValidationTarget<IReadOnlyCollection<T>> target) => target.IsNullOrEmpty(null);
        ...
        [DebuggerHidden]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValidationResult<IReadOnlyCollection<T>> IsNullOrEmpty<T>(this ValidationTarget<IReadOnlyCollection<T>> target, String targetParameterName) => target.RejectIfIsNullOrEmpty<IReadOnlyCollection<T>, T>(targetParameterName);
    }
}