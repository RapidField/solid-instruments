...
{
    /// <summary>
    /// Extends the <see cref="ValidationTarget{TArgument}" /> class with validation features for array arguments.
    /// </summary>
    public static class ValidationTargetArrayExtensions
    {
        /// <summary>
        ...
        public static ValidationResult<T[]> IsNullOrEmpty<T>(this ValidationTarget<T[]> target) => target.IsNullOrEmpty(null);
