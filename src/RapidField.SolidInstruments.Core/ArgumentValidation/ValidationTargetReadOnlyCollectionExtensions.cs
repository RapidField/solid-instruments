...
namespace RapidField.SolidInstruments.Core.ArgumentValidation
{
    ...
    /// <see cref="ReadOnlyCollection{T}" /> arguments.
    /// </summary>
    public static class ValidationTargetReadOnlyCollectionExtensions
    {
        /// <summary>
        ...
        public static ValidationResult<ReadOnlyCollection<T>> IsNullOrEmpty<T>(this ValidationTarget<ReadOnlyCollection<T>> target) => target.IsNullOrEmpty(null);
        ...
        [DebuggerHidden]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValidationResult<ReadOnlyCollection<T>> IsNullOrEmpty<T>(this ValidationTarget<ReadOnlyCollection<T>> target, String targetParameterName) => target.RejectIfIsNullOrEmpty<ReadOnlyCollection<T>, T>(targetParameterName);
    }
}