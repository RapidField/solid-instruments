...
{
    /// <summary>
    /// Represents the Twofish symmetric-key encryption cipher using a 128-bit key in Cipher Block Chaining (CBC) mode.
    /// </summary>
    internal sealed class Twofish128CbcCipher : TwofishCipher
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Twofish128CbcCipher" /> class.
        /// </summary>
        ...
        /// </exception>
        [DebuggerHidden]
        public Twofish128CbcCipher(RandomNumberGenerator randomnessProvider)
        ...
        /// <summary>
        /// Releases all resources consumed by the current <see cref="Twofish128CbcCipher" />.
        /// </summary>
