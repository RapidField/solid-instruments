...
{
    /// <summary>
    /// Represents the Twofish symmetric-key encryption cipher using a 256-bit key in Electronic Codebook (ECB) mode.
    /// </summary>
    internal sealed class Twofish256EcbCipher : TwofishCipher
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Twofish256EcbCipher" /> class.
        /// </summary>
        ...
        /// </exception>
        [DebuggerHidden]
        public Twofish256EcbCipher(RandomNumberGenerator randomnessProvider)
        ...
        /// <summary>
        /// Releases all resources consumed by the current <see cref="Twofish256EcbCipher" />.
        /// </summary>
