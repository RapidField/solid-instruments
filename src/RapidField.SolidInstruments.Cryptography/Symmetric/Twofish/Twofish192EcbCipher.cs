...
{
    /// <summary>
    /// Represents the Twofish symmetric-key encryption cipher using a 192-bit key in Electronic Codebook (ECB) mode.
    /// </summary>
    internal sealed class Twofish192EcbCipher : TwofishCipher
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Twofish192EcbCipher" /> class.
        /// </summary>
        ...
        /// </exception>
        [DebuggerHidden]
        public Twofish192EcbCipher(RandomNumberGenerator randomnessProvider)
        ...
        /// <summary>
        /// Releases all resources consumed by the current <see cref="Twofish192EcbCipher" />.
        /// </summary>
