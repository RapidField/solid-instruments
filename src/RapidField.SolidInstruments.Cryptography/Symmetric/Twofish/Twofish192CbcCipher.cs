...
{
    /// <summary>
    /// Represents the Twofish symmetric-key encryption cipher using a 192-bit key in Cipher Block Chaining (CBC) mode.
    /// </summary>
    internal sealed class Twofish192CbcCipher : TwofishCipher
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Twofish192CbcCipher" /> class.
        /// </summary>
        ...
        /// </exception>
        [DebuggerHidden]
        public Twofish192CbcCipher(RandomNumberGenerator randomnessProvider)
        ...
        /// <summary>
        /// Releases all resources consumed by the current <see cref="Twofish192CbcCipher" />.
        /// </summary>
        ...
        private const Int32 KeySizeSetting = 192;
