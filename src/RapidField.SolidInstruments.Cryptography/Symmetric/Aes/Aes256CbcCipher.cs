...
{
    /// <summary>
    /// Represents the AES symmetric-key encryption cipher using a 256-bit key in Cipher Block Chaining (CBC) mode.
    /// </summary>
    internal sealed class Aes256CbcCipher : AesCipher
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Aes256CbcCipher" /> class.
        /// </summary>
        ...
        /// </exception>
        [DebuggerHidden]
        public Aes256CbcCipher(RandomNumberGenerator randomnessProvider)
        ...
        /// <summary>
        /// Releases all resources consumed by the current <see cref="Aes256CbcCipher" />.
        /// </summary>
