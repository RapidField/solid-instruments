...
{
    /// <summary>
    /// Represents the AES symmetric-key encryption cipher using a 128-bit key in Electronic Codebook (ECB) mode.
    /// </summary>
    internal sealed class Aes128EcbCipher : AesCipher
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Aes128EcbCipher" /> class.
        /// </summary>
        ...
        /// </exception>
        [DebuggerHidden]
        public Aes128EcbCipher(RandomNumberGenerator randomnessProvider)
        ...
        /// <summary>
        /// Releases all resources consumed by the current <see cref="Aes128EcbCipher" />.
        /// </summary>
