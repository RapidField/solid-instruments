...
{
    /// <summary>
    /// Represents the Threefish symmetric-key encryption cipher using a 1024-bit key in Electronic Codebook (ECB) mode.
    /// </summary>
    internal sealed class Threefish1024EcbCipher : ThreefishCipher
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Threefish1024EcbCipher" /> class.
        /// </summary>
        ...
        /// </exception>
        [DebuggerHidden]
        public Threefish1024EcbCipher(RandomNumberGenerator randomnessProvider)
        ...
        /// <summary>
        /// Releases all resources consumed by the current <see cref="Threefish1024EcbCipher" />.
        /// </summary>
