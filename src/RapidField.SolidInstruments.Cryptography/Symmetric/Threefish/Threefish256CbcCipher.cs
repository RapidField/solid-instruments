...
{
    /// <summary>
    /// Represents the Threefish symmetric-key encryption cipher using a 256-bit key in Cipher Block Chaining (CBC) mode.
    /// </summary>
    internal sealed class Threefish256CbcCipher : ThreefishCipher
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Threefish256CbcCipher" /> class.
        /// </summary>
        ...
        /// </exception>
        [DebuggerHidden]
        public Threefish256CbcCipher(RandomNumberGenerator randomnessProvider)
        ...
        /// <summary>
        /// Releases all resources consumed by the current <see cref="Threefish256CbcCipher" />.
        /// </summary>
