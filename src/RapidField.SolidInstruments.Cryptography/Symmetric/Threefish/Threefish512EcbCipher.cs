...
{
    /// <summary>
    /// Represents the Threefish symmetric-key encryption cipher using a 512-bit key in Electronic Codebook (ECB) mode.
    /// </summary>
    internal sealed class Threefish512EcbCipher : ThreefishCipher
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Threefish512EcbCipher" /> class.
        /// </summary>
        ...
        /// </exception>
        [DebuggerHidden]
        public Threefish512EcbCipher(RandomNumberGenerator randomnessProvider)
        ...
        /// <summary>
        /// Releases all resources consumed by the current <see cref="Threefish512EcbCipher" />.
        /// </summary>
