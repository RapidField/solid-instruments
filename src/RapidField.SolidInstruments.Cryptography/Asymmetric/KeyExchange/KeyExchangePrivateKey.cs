...
namespace RapidField.SolidInstruments.Cryptography.Asymmetric.KeyExchange
{
    ...
    public abstract class KeyExchangePrivateKey : CryptographicKey<KeyExchangeAlgorithmSpecification>, IKeyExchangePrivateKey
    {
        ...
        /// </exception>
        protected KeyExchangePrivateKey(Guid keyPairIdentifier, KeyExchangeAlgorithmSpecification algorithm, CryptographicKeyDerivationMode derivationMode, PinnedMemory keySource, DateTime expirationTimeStamp)
