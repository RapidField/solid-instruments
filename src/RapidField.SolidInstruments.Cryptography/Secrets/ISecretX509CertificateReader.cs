...
namespace RapidField.SolidInstruments.Cryptography.Secrets
{
    ...
    /// </summary>
    public interface ISecretX509CertificateReader : ISecretStore
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the number of <see cref="X509CertificateSecret" /> objects that are stored by the <see cref="ISecretStore" />.
        /// </summary>
        /// <exception cref="ObjectDisposedException">
        /// The object is disposed.
        /// </exception>
