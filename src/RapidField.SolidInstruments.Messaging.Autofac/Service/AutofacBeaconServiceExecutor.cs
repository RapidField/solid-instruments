...
namespace RapidField.SolidInstruments.Messaging.Autofac.Service
{
    ...
    /// and responds to <see cref="PingRequestMessage" /> instances using an Autofac dependency package.
    /// </summary>
    /// <remarks>
    ...
    /// </typeparam>
    public abstract class AutofacBeaconServiceExecutor<TDependencyPackage> : BeaconServiceExecutor<TDependencyPackage, ServiceCollection, AutofacDependencyEngine>
        where TDependencyPackage : class, IDependencyPackage<ServiceCollection, AutofacDependencyEngine>, new()
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AutofacBeaconServiceExecutor{TDependencyPackage}" /> class.
        /// </summary>
        protected AutofacBeaconServiceExecutor()
            : base()
        {
            return;
        }
        ...
        /// </param>
        protected AutofacBeaconServiceExecutor(Boolean publishesFrequencyAHeartbeats, Boolean publishesFrequencyBHeartbeats)
        ...
        /// </param>
        protected AutofacBeaconServiceExecutor(Boolean publishesFrequencyAHeartbeats, Boolean publishesFrequencyBHeartbeats, Boolean publishesFrequencyCHeartbeats, Boolean publishesFrequencyDHeartbeats, Boolean publishesFrequencyEHeartbeats)
        ...
        /// </exception>
        protected AutofacBeaconServiceExecutor(String serviceName)
            : base(serviceName)
        {
            return;
        }
        ...
        /// <paramref name="serviceName" /> is <see langword="null" />.
        /// </exception>
        protected AutofacBeaconServiceExecutor(String serviceName, Boolean publishesFrequencyAHeartbeats, Boolean publishesFrequencyBHeartbeats)
        ...
        /// <paramref name="serviceName" /> is <see langword="null" />.
        /// </exception>
        protected AutofacBeaconServiceExecutor(String serviceName, Boolean publishesFrequencyAHeartbeats, Boolean publishesFrequencyBHeartbeats, Boolean publishesFrequencyCHeartbeats, Boolean publishesFrequencyDHeartbeats, Boolean publishesFrequencyEHeartbeats)
        ...
        /// <summary>
        /// Releases all resources consumed by the current <see cref="AutofacBeaconServiceExecutor{TDependencyPackage}" />.
        /// </summary>
