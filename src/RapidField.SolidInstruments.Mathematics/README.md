...
Refer to the [**API Reference**](https://www.solidinstruments.com/api/RapidField.SolidInstruments.Mathematics.html) for usage examples and reference documentation.
