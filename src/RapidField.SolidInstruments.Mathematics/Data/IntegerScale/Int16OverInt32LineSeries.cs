...
{
    /// <summary>
    /// Represents a line series that is comprised of 16-bit integer values measured over a 32-bit integer scale.
    /// </summary>
    public class Int16OverInt32LineSeries : ScalarLineSeries<Int32, Int16>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Int16OverInt32LineSeries" /> class.
        /// </summary>
        /// <param name="data">
        ...
        /// </exception>
        public Int16OverInt32LineSeries(IDictionary<Int32, Int16> data)
            : base(data)
        {
            return;
        }
        ...
        /// </returns>
        protected sealed override Int16 InterpolateLinear(Int32 xAxisValue, Int32 downwardXAxisValue, Int16 downwardYAxisValue, Int32 upwardXAxisValue, Int16 upwardYAxisValue)
        {
        ...
        /// The resulting y-axis value.
        /// </returns>
        protected sealed override Int16 InterpolateNearest(Int32 xAxisValue, Int32 downwardXAxisValue, Int16 downwardYAxisValue, Int32 upwardXAxisValue, Int16 upwardYAxisValue)
        {
            var positionInXAxisRange = xAxisValue.PositionInRange(downwardXAxisValue, upwardXAxisValue);
