...
{
    /// <summary>
    /// Represents a line series that is comprised of double-precision floating-point number values measured over a 32-bit integer
    /// scale.
    /// </summary>
    public class DoubleOverInt32LineSeries : ScalarLineSeries<Int32, Double>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleOverInt32LineSeries" /> class.
        /// </summary>
        /// <param name="data">
        ...
        /// </exception>
        public DoubleOverInt32LineSeries(IDictionary<Int32, Double> data)
            : base(data)
        {
            return;
        }
        ...
        /// </returns>
        protected sealed override Double InterpolateLinear(Int32 xAxisValue, Int32 downwardXAxisValue, Double downwardYAxisValue, Int32 upwardXAxisValue, Double upwardYAxisValue)
        {
        ...
        /// The resulting y-axis value.
        /// </returns>
        protected sealed override Double InterpolateNearest(Int32 xAxisValue, Int32 downwardXAxisValue, Double downwardYAxisValue, Int32 upwardXAxisValue, Double upwardYAxisValue)
        {
            var positionInXAxisRange = xAxisValue.PositionInRange(downwardXAxisValue, upwardXAxisValue);
