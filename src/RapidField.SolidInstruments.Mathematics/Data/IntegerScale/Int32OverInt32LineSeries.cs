...
{
    /// <summary>
    /// Represents a line series that is comprised of 32-bit integer values measured over a 32-bit integer scale.
    /// </summary>
    public class Int32OverInt32LineSeries : ScalarLineSeries<Int32, Int32>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Int32OverInt32LineSeries" /> class.
        /// </summary>
        /// <param name="data">
        ...
        /// </exception>
        public Int32OverInt32LineSeries(IDictionary<Int32, Int32> data)
            : base(data)
        {
            return;
        }
        ...
        /// </returns>
        protected sealed override Int32 InterpolateLinear(Int32 xAxisValue, Int32 downwardXAxisValue, Int32 downwardYAxisValue, Int32 upwardXAxisValue, Int32 upwardYAxisValue)
        {
        ...
        /// The resulting y-axis value.
        /// </returns>
        protected sealed override Int32 InterpolateNearest(Int32 xAxisValue, Int32 downwardXAxisValue, Int32 downwardYAxisValue, Int32 upwardXAxisValue, Int32 upwardYAxisValue)
        {
            var positionInXAxisRange = xAxisValue.PositionInRange(downwardXAxisValue, upwardXAxisValue);
