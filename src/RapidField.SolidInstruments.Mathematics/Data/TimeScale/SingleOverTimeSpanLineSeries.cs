...
namespace RapidField.SolidInstruments.Mathematics.Data.TimeScale
{
    /// <summary>
    /// Represents a line series that is comprised of single-precision floating-point number values measured over time.
    /// </summary>
    public class SingleOverTimeSpanLineSeries : ScalarLineSeries<TimeSpan, Single>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SingleOverTimeSpanLineSeries" /> class.
        /// </summary>
        /// <param name="data">
        ...
        /// </exception>
        public SingleOverTimeSpanLineSeries(IDictionary<TimeSpan, Single> data)
            : base(data)
        {
            return;
        }
        ...
        /// </returns>
        protected sealed override Single InterpolateLinear(TimeSpan xAxisValue, TimeSpan downwardXAxisValue, Single downwardYAxisValue, TimeSpan upwardXAxisValue, Single upwardYAxisValue)
        {
        ...
        /// The resulting y-axis value.
        /// </returns>
        protected sealed override Single InterpolateNearest(TimeSpan xAxisValue, TimeSpan downwardXAxisValue, Single downwardYAxisValue, TimeSpan upwardXAxisValue, Single upwardYAxisValue)
        {
