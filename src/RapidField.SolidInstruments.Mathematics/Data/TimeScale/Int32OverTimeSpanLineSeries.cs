...
{
    /// <summary>
    /// Represents a line series that is comprised of 32-bit integer values measured over time.
    /// </summary>
    public class Int32OverTimeSpanLineSeries : ScalarLineSeries<TimeSpan, Int32>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Int32OverTimeSpanLineSeries" /> class.
        /// </summary>
        /// <param name="data">
        ...
        /// </exception>
        public Int32OverTimeSpanLineSeries(IDictionary<TimeSpan, Int32> data)
            : base(data)
        {
            return;
        }
        ...
        /// </returns>
        protected sealed override Int32 InterpolateLinear(TimeSpan xAxisValue, TimeSpan downwardXAxisValue, Int32 downwardYAxisValue, TimeSpan upwardXAxisValue, Int32 upwardYAxisValue)
        {
