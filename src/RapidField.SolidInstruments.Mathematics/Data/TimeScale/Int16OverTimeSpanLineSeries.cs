...
{
    /// <summary>
    /// Represents a line series that is comprised of 16-bit integer values measured over time.
    /// </summary>
    public class Int16OverTimeSpanLineSeries : ScalarLineSeries<TimeSpan, Int16>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Int16OverTimeSpanLineSeries" /> class.
        /// </summary>
        /// <param name="data">
        ...
        /// </exception>
        public Int16OverTimeSpanLineSeries(IDictionary<TimeSpan, Int16> data)
            : base(data)
        {
            return;
        }
        ...
        /// </returns>
        protected sealed override Int16 InterpolateLinear(TimeSpan xAxisValue, TimeSpan downwardXAxisValue, Int16 downwardYAxisValue, TimeSpan upwardXAxisValue, Int16 upwardYAxisValue)
        {
        ...
        /// The resulting y-axis value.
        /// </returns>
        protected sealed override Int16 InterpolateNearest(TimeSpan xAxisValue, TimeSpan downwardXAxisValue, Int16 downwardYAxisValue, TimeSpan upwardXAxisValue, Int16 upwardYAxisValue)
        {
            var positionInXAxisRange = xAxisValue.PositionInRange(downwardXAxisValue, upwardXAxisValue);
