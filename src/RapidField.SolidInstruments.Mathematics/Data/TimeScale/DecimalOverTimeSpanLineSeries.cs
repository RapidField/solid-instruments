...
{
    /// <summary>
    /// Represents a line series that is comprised of decimal number values measured over time.
    /// </summary>
    public class DecimalOverTimeSpanLineSeries : ScalarLineSeries<TimeSpan, Decimal>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DecimalOverTimeSpanLineSeries" /> class.
        /// </summary>
        /// <param name="data">
        ...
        /// </exception>
        public DecimalOverTimeSpanLineSeries(IDictionary<TimeSpan, Decimal> data)
            : base(data)
        {
            return;
        }
        ...
        /// </returns>
        protected sealed override Decimal InterpolateLinear(TimeSpan xAxisValue, TimeSpan downwardXAxisValue, Decimal downwardYAxisValue, TimeSpan upwardXAxisValue, Decimal upwardYAxisValue)
        {
        ...
        /// The resulting y-axis value.
        /// </returns>
        protected sealed override Decimal InterpolateNearest(TimeSpan xAxisValue, TimeSpan downwardXAxisValue, Decimal downwardYAxisValue, TimeSpan upwardXAxisValue, Decimal upwardYAxisValue)
        {
