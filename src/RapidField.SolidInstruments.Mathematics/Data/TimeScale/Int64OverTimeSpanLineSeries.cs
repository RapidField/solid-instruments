...
{
    /// <summary>
    /// Represents a line series that is comprised of 64-bit integer values measured over time.
    /// </summary>
    public class Int64OverTimeSpanLineSeries : ScalarLineSeries<TimeSpan, Int64>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Int64OverTimeSpanLineSeries" /> class.
        /// </summary>
        /// <param name="data">
        ...
        /// </exception>
        public Int64OverTimeSpanLineSeries(IDictionary<TimeSpan, Int64> data)
            : base(data)
        {
            return;
        }
        ...
        /// </returns>
        protected sealed override Int64 InterpolateLinear(TimeSpan xAxisValue, TimeSpan downwardXAxisValue, Int64 downwardYAxisValue, TimeSpan upwardXAxisValue, Int64 upwardYAxisValue)
        {
        ...
        /// The resulting y-axis value.
        /// </returns>
        protected sealed override Int64 InterpolateNearest(TimeSpan xAxisValue, TimeSpan downwardXAxisValue, Int64 downwardYAxisValue, TimeSpan upwardXAxisValue, Int64 upwardYAxisValue)
        {
            var positionInXAxisRange = xAxisValue.PositionInRange(downwardXAxisValue, upwardXAxisValue);
