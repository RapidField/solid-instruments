...
{
    /// <summary>
    /// Represents a line series that is comprised of 32-bit integer values measured over a rational number scale.
    /// </summary>
    public class Int32OverDoubleLineSeries : ScalarLineSeries<Double, Int32>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Int32OverDoubleLineSeries" /> class.
        /// </summary>
        /// <param name="data">
        ...
        /// </exception>
        public Int32OverDoubleLineSeries(IDictionary<Double, Int32> data)
            : base(data)
        {
            return;
        }
        ...
        /// </returns>
        protected sealed override Int32 InterpolateLinear(Double xAxisValue, Double downwardXAxisValue, Int32 downwardYAxisValue, Double upwardXAxisValue, Int32 upwardYAxisValue)
        {
        ...
        /// The resulting y-axis value.
        /// </returns>
        protected sealed override Int32 InterpolateNearest(Double xAxisValue, Double downwardXAxisValue, Int32 downwardYAxisValue, Double upwardXAxisValue, Int32 upwardYAxisValue)
        {
            var positionInXAxisRange = xAxisValue.PositionInRange(downwardXAxisValue, upwardXAxisValue);
