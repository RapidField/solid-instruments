...
{
    /// <summary>
    /// Represents a line series that is comprised of double-precision floating-point number values measured over a rational number
    /// scale.
    /// </summary>
    public class DoubleOverDoubleLineSeries : ScalarLineSeries<Double, Double>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleOverDoubleLineSeries" /> class.
        /// </summary>
        /// <param name="data">
        ...
        /// </exception>
        public DoubleOverDoubleLineSeries(IDictionary<Double, Double> data)
            : base(data)
        {
            return;
        }
        ...
        /// </returns>
        protected sealed override Double InterpolateLinear(Double xAxisValue, Double downwardXAxisValue, Double downwardYAxisValue, Double upwardXAxisValue, Double upwardYAxisValue)
        {
        ...
        /// The resulting y-axis value.
        /// </returns>
        protected sealed override Double InterpolateNearest(Double xAxisValue, Double downwardXAxisValue, Double downwardYAxisValue, Double upwardXAxisValue, Double upwardYAxisValue)
        {
            var positionInXAxisRange = xAxisValue.PositionInRange(downwardXAxisValue, upwardXAxisValue);
