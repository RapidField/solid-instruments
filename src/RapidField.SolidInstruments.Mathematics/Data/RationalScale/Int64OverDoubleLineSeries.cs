...
{
    /// <summary>
    /// Represents a line series that is comprised of 64-bit integer values measured over a rational number scale.
    /// </summary>
    public class Int64OverDoubleLineSeries : ScalarLineSeries<Double, Int64>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Int64OverDoubleLineSeries" /> class.
        /// </summary>
        /// <param name="data">
        ...
        /// </exception>
        public Int64OverDoubleLineSeries(IDictionary<Double, Int64> data)
            : base(data)
        {
            return;
        }
        ...
        /// </returns>
        protected sealed override Int64 InterpolateLinear(Double xAxisValue, Double downwardXAxisValue, Int64 downwardYAxisValue, Double upwardXAxisValue, Int64 upwardYAxisValue)
        {
