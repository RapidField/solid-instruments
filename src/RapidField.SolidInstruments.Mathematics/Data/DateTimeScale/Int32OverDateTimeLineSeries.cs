...
{
    /// <summary>
    /// Represents a line series that is comprised of 32-bit integer values measured over date and time.
    /// </summary>
    public class Int32OverDateTimeLineSeries : ScalarLineSeries<DateTime, Int32>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Int32OverDateTimeLineSeries" /> class.
        /// </summary>
        /// <param name="data">
        ...
        /// </exception>
        public Int32OverDateTimeLineSeries(IDictionary<DateTime, Int32> data)
            : base(data)
        {
            return;
        }
        ...
        /// </returns>
        protected sealed override Int32 InterpolateLinear(DateTime xAxisValue, DateTime downwardXAxisValue, Int32 downwardYAxisValue, DateTime upwardXAxisValue, Int32 upwardYAxisValue)
        {
            ...
            return Convert.ToInt32((downwardYAxisValue.ToDouble() + adjustment).RoundedTo(0, MidpointRounding.AwayFromZero));
        }
        ...
        /// The resulting y-axis value.
        /// </returns>
        protected sealed override Int32 InterpolateNearest(DateTime xAxisValue, DateTime downwardXAxisValue, Int32 downwardYAxisValue, DateTime upwardXAxisValue, Int32 upwardYAxisValue)
        {
            var positionInXAxisRange = xAxisValue.PositionInRange(downwardXAxisValue, upwardXAxisValue);
