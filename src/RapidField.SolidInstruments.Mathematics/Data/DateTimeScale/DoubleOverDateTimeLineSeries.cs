...
{
    /// <summary>
    /// Represents a line series that is comprised of double-precision floating-point number values measured over date and time.
    /// </summary>
    public class DoubleOverDateTimeLineSeries : ScalarLineSeries<DateTime, Double>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoubleOverDateTimeLineSeries" /> class.
        /// </summary>
        /// <param name="data">
        ...
        /// </exception>
        public DoubleOverDateTimeLineSeries(IDictionary<DateTime, Double> data)
            : base(data)
        {
            return;
        }
