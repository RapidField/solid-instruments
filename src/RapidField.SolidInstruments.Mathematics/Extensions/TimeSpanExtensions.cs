...
{
    /// <summary>
    /// Extends the <see cref="TimeSpan" /> structure with mathematics features.
    /// </summary>
    public static class TimeSpanExtensions
    {
        /// <summary>
        /// Returns the position of the current <see cref="TimeSpan" /> within the specified range, expressed as a percentage where
        /// zero is equal to the lower boundary and one is equal to the upper boundary.
        /// </summary>
        /// <param name="target">
        /// The current <see cref="TimeSpan" />.
        /// </param>
        ...
        /// </param>
        /// <returns>
        /// The position of the current <see cref="TimeSpan" /> within the specified range.
        /// </returns>
        ...
        /// </exception>
        public static Double PositionInRange(this TimeSpan target, TimeSpan lowerBoundary, TimeSpan upperBoundary)
        {
